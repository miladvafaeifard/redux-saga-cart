...
import { SET_CART_ITEMS, INCREASE_ITEM_QUANTITY, DECREASE_ITEM_QUANTITY, setShippingFetchStatus, FETCHED, FETCHING, setShippingCost } from './../actions';
...
function* shipping() {
    ...
    const itemRequestString = items.reduce((str, item) => {
    ...
    console.info('Made item requst string: ', itemRequestString);
